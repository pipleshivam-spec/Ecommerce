        ...
        <div className="absolute bottom-0 left-0 right-0 p-3 translate-y-0 sm:translate-y-full sm:group-hover:translate-y-0 transition-transform duration-300">
          <div className="flex gap-2">
            ...
            <Link to={`/product/${product.id}`}
              className="p-2.5 rounded-md bg-background/80 backdrop-blur-sm text-foreground hover:bg-background transition-colors">
              <Eye size={14} />
            </Link>
            <button onClick={handleWishlist}
              className={`p-2.5 rounded-md backdrop-blur-sm transition-colors ${
